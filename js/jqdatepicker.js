...
function(e, t) {
	...
	function k(e, n, r, i, o, a) {
		...
		for (var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === _t; u < c && (f || !s); u++) s = l[u](n, r, i), "string" == typeof s && (!f || a[s] ? s = t : (n.dataTypes.unshift(s), s = k(e, n, r, i, s, a)));
	...
	function F(e, t, n) {
		var r, i = 0,
			...
			s = function() {
				for (var t = Yt || L(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, i = 1 - r, o = 0, s = l.tweens.length; o < s; o++) l.tweens[o].run(i);
			...
			u = l.props;
		for (M(u, l.opts.specialEasing); i < o; i++) if (r = Kt[i].call(l, e, u, l.opts)) return r;
	...
	K.fn = K.prototype = {
		...
		type: function(e) {
			return null == e ? String(e) : de[J.call(e)] || "object"
		},
		...
		map: function(e, n, r) {
			...
			if (u) for (; s < l; s++) i = n(e[s], s, r), null != i && (a[a.length] = i);
	...
	K.fn.extend({
		...
		removeClass: function(e) {
			...
			if (e && "string" == typeof e || e === t) for (n = (e || "").split(te), s = 0, l = this.length; s < l; s++) if (i = this[s], 1 === i.nodeType && i.className) {
				for (r = (" " + i.className + " ").replace(xe, " "), o = 0, a = n.length; o < a; o++) for (; r.indexOf(" " + n[o] + " ") >= 0;) r = r.replace(" " + n[o] + " ", " ");
		...
		valHooks: {
			...
			select: {
				get: function(e) {
					for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, l = i < 0 ? s : o ? i : 0; l < s; l++) if (n = r[l], (n.selected || l === i) && (K.support.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !K.nodeName(n.parentNode, "optgroup"))) {
		...
		removeAttr: function(e, t) {
			var n, r, i, o, a = 0;
			if (t && 1 === e.nodeType) for (r = t.split(te); a < r.length; a++) i = r[a], i && (n = K.propFix[i] || i, o = ke.test(i), o || K.attr(e, i, ""), e.removeAttribute(Ee ? i : n), o && n in e && (e[n] = !1))
		},
		attrHooks: {
			type: {
				set: function(e, t) {
	...
	}, K.event.handle = K.event.dispatch, K.removeEvent = R.removeEventListener ?
	function(e, t, n) {
		...
		function n(e, t, n, r) {
			...
			if (a = w(t), !a && !r && (i = ne.exec(e))) if (s = i[1]) {
				...
				if ((s = i[3]) && pe && t.getElementsByClassName) return _.apply(n, q.call(t.getElementsByClassName(s), 0)), n
			}
		...
		function s(e, t) {
			...
			for (s = e, l = [], u = b.preFilter; s;) {
				r && !(i = Z.exec(s)) || (i && (s = s.slice(i[0].length) || s), l.push(o = [])), r = !1, (i = ee.exec(s)) && (o.push(r = new D(i.shift())), s = s.slice(r.length), r.type = i[0].replace(Q, " "));
				for (a in b.filter)(i = se[a].exec(s)) && (!u[a] || (i = u[a](i))) && (o.push(r = new D(i.shift())), s = s.slice(r.length), r.type = a, r.matches = i);
				if (!r) break
			}
		...
		function p(e) {
			...
			}]; s < i; s++) if (n = b.relative[e[s].type]) h = [l(u(h), n)];
			else {
		...
		function g(e, t, n, r, i) {
			...
			return N(e, f)(r, t, i, n, re.test(e)), n
		}
		...
		}, R = P(), $ = P(), I = P(), z = "[\ \\t\\r\\n\\f]", X = "(?:\\\\.|[-\\w]|[^\-\ ])+", U = X.replace("w", "w#"), Y = "([*^$|!~]?=)", V = "\\[" + z + "*(" + X + ")" + z + "*(?:" + Y + z + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + U + ")|)|)" + z + "*\\]", J = ":(" + X + ")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:" + V + ")|[^:]|\\\\.)*|.*))\\)|)", G = ":(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + z + "*((?:-\\d)?\\d*)" + z + "*\\)|)(?=[^-]|$)", Q = new RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$", "g"), Z = new RegExp("^" + z + "*," + z + "*"), ee = new RegExp("^" + z + "*([\ \\t\\r\\n\\f>+~])" + z + "*"), te = new RegExp(J), ne = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, re = /[ \t\r\n\f]*[+~]/, ie = /h\d/i, oe = /input|select|textarea|button/i, ae = /\\(?!\\)/g, se = {
			ID: new RegExp("^#(" + X + ")"),
			CLASS: new RegExp("^\\.(" + X + ")"),
	...
	Ze.optgroup = Ze.option, Ze.tbody = Ze.tfoot = Ze.colgroup = Ze.caption = Ze.thead, Ze.th = Ze.td, K.support.htmlSerialize || (Ze._default = [1, "X<div>", "</div>"]), K.fn.extend({
		...
		html: function(e) {
			return K.access(this, function(e) {
				...
				if ("string" == typeof e && !Ue.test(e) && (K.support.htmlSerialize || !Ve.test(e)) && (K.support.leadingWhitespace || !Re.test(e)) && !Ze[(Ie.exec(e) || ["", ""])[1].toLowerCase()]) {
					e = e.replace($e, "<$1></$2>");
					try {
		...
		var i, o, a, s = e[0];
		return n = n || R, n = !n.nodeType && n[0] || n, n = n.ownerDocument || n, 1 === e.length && "string" == typeof s && s.length < 512 && n === R && "<" === s.charAt(0) && !Ye.test(s) && (K.support.checkClone || !Ge.test(s)) && (K.support.html5Clone || !Ve.test(s)) && (o = !0, i = K.fragments[s], a = i !== t), i || (i = n.createDocumentFragment(), K.clean(e, n, i, r), o && (K.fragments[s] = a && i)), {
			fragment: i,
			cacheable: o
		}
	}, K.fragments = {}, K.each({
		...
		clone: function(e, t, n) {
			var r, i, o, a;
			if (K.support.html5Clone || K.isXMLDoc(e) || !Ve.test("<" + e.nodeName + ">") ? a = e.cloneNode(!0) : (tt.innerHTML = e.outerHTML, tt.removeChild(a = tt.firstChild)), !(K.support.noCloneEvent && K.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || K.isXMLDoc(e))) for (d(e, a), r = h(e), i = h(a), o = 0; r[o]; ++o) i[o] && d(r[o], i[o]);
			if (t && (p(e, a), n)) for (r = h(e), i = h(a), o = 0; r[o]; ++o) p(r[o], i[o]);
			return r = i = null, a
		},
		clean: function(e, t, n, r) {
			var i, o, a, s, l, u, f, p, d, h, m, y = t === R && et,
				v = [];
	...
	try {
		...
		kt = R.createElement("a"), kt.href = "", kt = kt.href
	}
	Ct = Mt.exec(kt.toLowerCase()) || [], K.fn.load = function(e, n, r) {
	...
	K.ajaxSetup({
		...
		var o, a, s, l = n.data,
			...
			c = n.jsonp !== !1,
			f = c && $t.test(u),
			p = c && !f && "string" == typeof l && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && $t.test(l);
		if ("jsonp" === n.dataTypes[0] || f || p) return o = n.jsonpCallback = K.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, a = e[o], f ? n.url = u.replace($t, "$1" + o) : p ? n.data = l.replace($t, "$1" + o) : c && (n.url += (Rt.test(u) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
	...
	K.Animation = K.extend(F, {
		...
		var e, n = K.timers,
			r = 0;
		for (Yt = K.now(); r < n.length; r++) e = n[r], !e() && n[r] === e && n.splice(r--, 1);
		n.length || K.fx.stop(), Yt = t
	}, K.fx.timer = function(e) {
		e() && K.timers.push(e) && !Vt && (Vt = setInterval(K.fx.tick, K.fx.interval))
	...
	K.fn.offset = function(e) {
		...
		offsetParent: function() {
			return this.map(function() {
				for (var e = this.offsetParent || R.body; e && !en.test(e.nodeName) && "static" === K.css(e, "position");) e = e.offsetParent;
				return e || R.body
			})
		}
	}), K.each({
...
function(e, t) {
	function a(t) {
		for (var a, s, n, i, d = "", r = new Date, l = r.getMonth(); t--;) {
			r.getMonth() !== l && r.setDate(1), a = k(r, "yyyy/mm/dd"), r.setMonth(r.getMonth() + 1, 1), r.setDate(0), s = k(r, "yyyy/mm/dd"), n = a + "-" + s, i = e.fn.datePicker.months.cn[r.getMonth()], d += '<span class="tag" data-range="' + n + '">' + i + "</span> ";
			var c = new Date(a).getMonth() === (new Date).getMonth() ? new Date : new Date(a);
			n = [];
			for (var o = "", l = c.getMonth(); c.getMonth() === l;) if (0 === c.getDay()) o = k(c, "yyyy/mm/dd") + "-" + k(c, "yyyy/mm/dd"), n.push(o), c.setDate(c.getDate() + 6);
			else {
				for (; 6 !== c.getDay();) c.setDate(c.getDate() + 1);
				for (; c.getMonth() === l;) {
					if (o = k(c, "yyyy/mm/dd"), c.setDate(c.getDate() + 1), c.getMonth() !== l) {
						o += "-" + o, n.push(o);
						break
					}
					o += "-" + k(c, "yyyy/mm/dd"), n.push(o), c.setDate(c.getDate() + 6)
				}
			}
			n = n.join(","), i = e.fn.datePicker.months.cn[r.getMonth()] + "的周末", r.setMonth(r.getMonth() + 1, 1), d += n ? '<span class="sm_tag" data-range="' + n + '">' + i + "</span> " : '<span class="sm_tag disabled" data-range="' + n + '">' + i + "</span> "
		}
		return r = new Date, a = k(r, "yyyy/mm/dd"), r.setDate(r.getDate() + 6), s = k(r, "yyyy/mm/dd"), n = a + "-" + s, i = "一周内", d += '<span class="sm_tag" data-range="' + n + '">' + i + "</span> "
	}

	function s(t, a) {
		var s = this;
		if (this.$input = e(t), !this.$input.length) throw new Error("no input element.");
		e.extend(this, R, a), this.displayed instanceof Date || (this.displayed = new Date, this.displayed.setDate(15)), this.dateUpdater === x && (this.dateUpdater = function(e) {
			if ("cn" !== s.language) return e.getDate();
			var t, a = e.getDate();
			if (s.enableSolarFestival) {
				var n = e.getMonth() + 1;
				if (t = "" + (n < 10 ? "0" : "") + n + (a < 10 ? "0" : "") + a, t in b) return b[t]
			}
			if (s.enableLunarFestival) {
				var i = w(e),
					d = 0 | i.day,
					r = i.month;
				if (t = "" + (r < 10 ? "0" : "") + r + (d < 10 ? "0" : "") + d, t in C) return C[t]
			}
			if (s.enableSolarTerm) {
				var l = D.getMonthSolarTerms(e.getFullYear(), e.getMonth());
				if (a in l) return l[a]
			}
			return a
		}), this.init()
	}
	var n = /^(yy|yyyy)([^ym]*)(m{1,2})([^md]*)(d{1,2})$/i,
		i = /^(?:(\d{4})\/)?(\d{1,2})(?:\/(\d{1,2}))?/,
		d = /^(y|m)(\d+)$/,
		r = '<div class="poi_calendar"></div>',
		l = '<div class="calendar_tag"><span class="lg_tag selected">任何时间</span></div>',
		c = '<div class="cus_checkbox"><label><i class="icon ico_checkbox"></i>自定义出行时间</label><div class="date_selected">可前后浮动天数 <i class="icon ico_minus disabled"></i><span class="date_txt">0</span><i class="icon ico_plus"></i></div></div>',
		o = l + c,
		h = '<div class="calendar_tit"><span class="month_switch">Month Year</span><span class="month_prev"><i class="ico_arrow"></i></span><span class="month_next"><i class="ico_arrow"></i></span></div>',
		g = '<div class="calendar_box"></div>',
		u = '<ul class="items"></ul>',
		f = '<li class="item">?</li>',
		m = '<div class="cus_days"><p>出游天数</p><span class="tag selected">不限</span><span class="tag" data-range="[3,5]">3-5天</span><span class="tag" data-range="[6,8]">6-8天</span><span class="tag" data-range="[9,11]">9-11天</span><span class="tag" data-range="[12,15]">12-15天</span></div>',
		p = '<div class="calendar_bottom"><a href="javascript:;" class="btn btn_confirm">确定</a></div>',
		y = m + p,
		v = e(t.body),
		D = function() {
			var e = {},
				t = [],
				a = ["小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑", "大暑", "立秋", "处暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至"],
				s = [0, 21208, 42467, 63836, 85337, 107014, 128867, 150921, 173149, 195551, 218072, 240693, 263343, 285989, 308563, 331033, 353350, 375494, 397447, 419210, 440795, 462224, 483532, 504758],
				n = function(e, t) {
					var a = new Date(31556925974.7 * (e - 1900) + 6e4 * s[t] + Date.UTC(1900, 0, 6, 2, 5));
					return a.getUTCDate()
				};
			return {
				getMonthSolarTerms: function(s, i) {
					s instanceof Date && (i = s.getMonth(), s = s.getFullYear());
					var d = "" + s + i;
					if (d in e) return e[d];
					var r, l = e[d] = {};
					return r = n(s - 1900, 2 * i), l[r - 1] = a[2 * i], r = n(s - 1900, 2 * i + 1), l[r - 1] = a[2 * i + 1], t.push(d), t.length > 12 && delete e[t.shift()], l
				}
			}
		}(),
		w = function() {
			function e(e) {
				var a, s = 348;
				for (a = 32768; a > 8; a >>= 1) s += i[e - 1900] & a ? 1 : 0;
				return s + t(e)
			}

			function t(e) {
				return a(e) ? 65536 & i[e - 1900] ? 30 : 29 : 0
			}
			...
			function n(n) {
				var i, d = 0,
					...
					c = (n - l) / 864e5,
					o = {};
				for (o.dayCyl = c + 40, o.monCyl = 14, i = 1900; i < 2050 && c > 0; i++) r = e(i), c -= r, o.monCyl += 12;
				for (c < 0 && (c += r, i--, o.monCyl -= 12), o.year = i, o.yearCyl = i - 1864, d = a(i), o.isLeap = !1, i = 1; i < 13 && c > 0; i++) d > 0 && i == d + 1 && 0 == o.isLeap ? (--i, o.isLeap = !0, r = t(o.year)) : r = s(o.year, i), 1 == o.isLeap && i == d + 1 && (o.isLeap = !1), c -= r, 0 == o.isLeap && o.monCyl++;
				return 0 == c && d > 0 && i == d + 1 && (o.isLeap ? o.isLeap = !1 : (o.isLeap = !0, --i, --o.monCyl)), c < 0 && (c += r, --i, --o.monCyl), o.month = i, o.day = c + 1, o
			}
		...
		M = function(e, t) {
			return e instanceof Date ? e : e instanceof s ? e.get(t) : void 0
		},
		k = function(e, t) {
			if (!e) return "";
			...
			var a = e.getFullYear(),
				s = e.getMonth() + 1,
				i = e.getDate();
			return t.replace(n, function(e, t, n, d, r, l) {
				return "" + (t && 2 === t.length ? a.substr(2) : a) + n + (d && 2 === d.length && s < 10 ? "0" + s : s) + r + (l && 2 === l.length && i < 10 ? "0" + i : i)
			})
		},
		x = function(e) {
			return e.getDate()
		...
		$ = function(e, t) {
			return e.getFullYear() + " " + t[e.getMonth()]
		},
		R = {
			language: "cn",
			currentPanel: "day",
		...
		F = function(e) {
			function t(e, t) {
				var a = i.exec(e);
				if (a) return a[1] || a[3] ? new Date(a[1] || t.getFullYear(), a[2] ? +a[2] - 1 : t.getMonth(), a[3] || t.getDate()) : new Date(t.getFullYear(), t.getMonth(), a[2])
			}
			if (!e) return null;
			e += "";
			var a = new Date,
		...
		L = function(t, a, s, n, i) {
			for (var d, r = ""; t--;) r += a;
			return d = e(s).append(r), i && d.addClass(i), n && d.children().addClass(n), d
		},
		T = function(e, t) {
			var a, s, n, i, d, r = new Date,
				l = (new Date).setHours(0, 0, 0, 0),
				c = "";
			r.setDate(r.getDate() + 89), r = r.setHours(23, 59, 59, 999);
			for (var o in e) t > 0 && (n = e[o].range, a = new Date(n.split("-")[0]).setHours(0, 0, 0, 0), s = new Date(n.split("-")[1]).setHours(23, 59, 59, 999), (s > l && s <= r || a >= l && a < r) && (a < l && (a = l), s > r && (s = r), i = k(new Date(a), "yyyy/mm/dd") + "-" + k(new Date(s), "yyyy/mm/dd"), d = e[o].text, c += '<span class="sm_tag" data-range="' + i + '">' + d + "</span> ", t--));
			return c
		},
		Y = function(t) {
			var s, n = t.templates,
				i = e(n.container);
			i.append(n.header).append(n.controller);
			var d = a(3);
			if (window.festivals) {
				var r = T(window.festivals, 3);
				i.find(".calendar_tag").append(d + r)
			} else e.ajax({
				url: "http://m.ctrip.com/restapi/soa2/11823/getHolidays",
				crossDomain: !0,
				success: function(e) {
					i.find(".calendar_tag").append(d + T(e.holidays, 3))
				}
			});
			return s = e(n.panel).addClass("day_panel").append(L(42, n.item, n.itemWrap, "day", "days")), s.prepend(L(7, n.item, n.itemWrap, "week", "weeks")), i.append(s), i.append(n.footer), i
		},
		U = function(t, a, s, n, i, d, r, l, c, o) {
			var h = new Date(s.getTime()),
				g = c && c[0] && c[0].from.setHours(0, 0, 0, 0),
				u = c && c[0] && c[0].to.setHours(23, 59, 59, 999),
				f = n && n.getTime(),
				m = i && i.getTime(),
				p = !0,
				y = t.find(".day");
			h.setDate(1), h.setDate(h.getDate() - h.getDay()), t.find(".month_switch").text(l(s, d)), y.each(function(t) {
				var n = e(this),
					d = h.getTime(),
					l = h.getDate();
				if (n.removeClass("disabled visibility old new selected selected_center selected_start selected_end"), n.data("zDay", l), n.text(r(h)), h.getMonth() !== s.getMonth()) {
					if (35 === t) return p = !1, !1;
					n.addClass("disabled visibility")
				} else g && u && g < d && u > d && (n.addClass("selected"), "range_center" !== o && "range_center_acc" !== o || !a || a.getDate() !== h.getDate() || n.addClass("selected_center"));
				(f && d < f || i && d > m) && n.removeClass("selected").addClass("disabled"), h.setDate(l + 1)
			}), y.slice(35)[p ? "show" : "hide"]()
		};
	s.prototype = {
		constructor: s,
		reflect: function(t) {
			if (function() {
				var e = new Date("2011-06-02T09:34:29+02:00");
				e && 1307000069e3 === +e ? Date.fromISO = function(e) {
					return new Date(e)
				} : Date.fromISO = function(e) {
					var t, a, s = /^(\d{4}\-\d\d\-\d\d([tT ][\d:\.]*)?)([zZ]|([+\-])(\d\d):(\d\d))?$/,
						n = s.exec(e) || [];
					if (n[1]) {
						t = n[1].split(/\D/);
						for (var i = 0, d = t.length; i < d; i++) t[i] = parseInt(t[i], 10) || 0;
						return t[1] -= 1, t = new Date(Date.UTC.apply(Date, t)), t.getDate() ? (n[5] && (a = 60 * parseInt(n[5], 10), n[6] && (a += parseInt(n[6], 10)), "+" == n[4] && (a *= -1), a && t.setUTCMinutes(t.getUTCMinutes() + a)), t) : NaN
					}
					return NaN
				}
			}(), t) {
				if (!t.mode) return;
				var a = this,
					s = M(this.start, "start"),
					n = M(this.end, "end"),
					i = this.$dom,
					d = H.months[this.language] || H.months._default,
					r = (H.weeks[this.language] || H.weeks._default, []);
				t.departDateRanges && t.departDateRanges.length > 0 && (this.range = [], e.each(t.departDateRanges, function() {
					a.range.push({
						from: Date.fromISO(this.startDate),
						to: Date.fromISO(this.endDate)
					}), r.push(k(Date.fromISO(this.startDate), "yyyy/mm/dd") + "-" + k(Date.fromISO(this.endDate), "yyyy/mm/dd"))
				})), "range_length_acc" === t.mode && (this.switchMode("range_length_acc"), t.departDateRanges && t.departDateRanges.length > 0 && (i.find(".calendar_tag").find("span").eq(0).removeClass("selected"), i.find(".calendar_tag").find("span:gt(0)").each(function() {
					var t = !0;
					_.each(e(this).data("range").split(","), function(e) {
						r.indexOf(e) === -1 && (t = !1)
					}), t ? e(this).addClass("selected") : e(this).removeClass("selected")
				}))), "range_center_acc" === t.mode && (this.switchMode("range_center_acc"), this.radius = t.radius, i.find(".date_txt").text(this.radius), t.radius > 1 && i.find(".ico_minus ").removeClass("disabled"), this.selected = t.selected ? Date.fromISO(t.selected) : new Date, this.displayed = new Date(this.displayed.setFullYear(this.selected.getFullYear(), this.selected.getMonth(), 15)), this.displayRange = this.range, s && s.setHours(0, 0, 0, 0), n && n.setHours(23, 59, 59, 999), U(i, this.selected, this.displayed, s, n, d, this.dateUpdater, this.titleUpdater, this.displayRange, this.mode)), t.minDays && t.maxDays && (this.rangeLen = [t.minDays, t.maxDays], i.find(".cus_days").find(".tag").eq(0).removeClass("selected"), i.find(".cus_days").find(".tag:gt(0)").each(function() {
					e(this).data("range").join(",") === a.rangeLen.join(",") ? e(this).addClass("selected") : e(this).removeClass("selected")
		...
		init: function() {
			var e = this.$input,
				t = Y(this);
			v.append(t.hide()), this.$dom = t, this.readonly && !e.attr("readonly") && (this.needRemoveReadonly = !0, e.attr("readonly", !0)), this.switchMode(this.mode), this.reset(), this.bindEvents(), e.trigger("init", [this, t]), this.reflectData && this.reflect(this.reflectData)
		},
		reset: function() {
			var t = M(this.start, "start"),
				a = M(this.end, "end"),
				s = this.$dom,
				n = H.months[this.language] || H.months._default,
				i = H.weeks[this.language] || H.weeks._default;
			this.radius = 0, s.find(".date_txt").text(this.radius), this.rangeLen = null, s.find(".cus_days").find(".tag").eq(0).addClass("selected").siblings().removeClass("selected"), this.range = void 0, s.find(".calendar_tag").find("span").eq(0).addClass("selected").siblings().removeClass("selected"), s.find(".week").each(function(t) {
				e(this).html(i[t])
			}), "range_center_acc" === this.mode ? this.switchMode("range_length_acc") : "range_center" === this.mode && this.switchMode("range_length"), this.selected = void 0, this.displayRange = null, t && t.setHours(0, 0, 0, 0), a && a.setHours(23, 59, 59, 999), U(s, this.selected, this.displayed, t, a, n, this.dateUpdater, this.titleUpdater, this.displayRange, this.mode)
		},
		bindEvents: function() {
			function a() {
				d.find(".date_txt").text(i.radius), r.trigger("radiuschange", i), i.selected || (i.selected = (new Date).addDays(1)), i.selectRangeByCenterDate(i.selected, i.radius), i.showval()
			}

			function s(e) {
				i.displayed.setMonth(i.displayed.getMonth() + e), U(d, i.selected, i.displayed, M(i.start, "start"), M(i.end, "end"), l, i.dateUpdater, i.titleUpdater, i.displayRange, i.mode), r.trigger("monthswitch", i)
			}

			function n() {
				o && clearTimeout(o), o = setTimeout(function() {
					var e = r.offset();
					e.top += r.outerHeight() + 8, d.css(e)
				}, 200)
			}
			var i = this,
				d = this.$dom,
				r = this.$input,
				l = H.months[this.language] || H.months._default,
				c = e(t);
			r.on("click", function(e) {
				e.stopPropagation();
				var t = r.offset();
				d.css({
					top: t.top + r.outerHeight() + 8,
					left: t.left - 40
				}), d.toggle()
				...
				e.stopPropagation()
			}), d.on("click", ".cus_checkbox label", function(t) {
				t.stopPropagation();
				var a = e(this).find("i");
				if (a.hasClass("ico_checkbox"))"range_length" === i.mode ? i.switchMode("range_center") : i.switchMode("range_center_acc"), d.find(".day.selected_center").trigger("click");
				else if (a.hasClass("ico_checkbox_active")) {
					"range_center" === i.mode ? i.switchMode("range_length") : i.switchMode("range_length_acc");
					var s = d.find(".calendar_tag .selected:first");
					s.trigger("click"), s.trigger("click")
				}
			}), d.find(".calendar_tag").on("click", ".tag,.sm_tag,.lg_tag", function(t) {
				t.preventDefault();
				var a = e(this);
				if (!a.hasClass("disabled")) {
					a.hasClass("lg_tag") ? (a.hasClass("selected") || a.addClass("selected").siblings().removeClass("selected"), i.displayRange = null) : a.siblings(".lg_tag").hasClass("selected") ? (a.siblings(".lg_tag").removeClass("selected"), a.addClass("selected")) : a.hasClass("selected") ? (a.removeClass("selected"), a.siblings(".selected").length || (a.siblings(".lg_tag").addClass("selected"), i.displayRange = null)) : a.addClass("selected");
					var s = i.$dom.find(".calendar_tag").children(".selected"),
						n = [];
					s.each(function() {
						n.push(e(this).data("range"))
					}), void 0 !== n[0] && i.selectRange(n.join(",")), i.showval()
				}
			}), d.on("click", ".day", function(t) {
				var a = e(this);
				if (!a.hasClass("disabled")) {
					var s = new Date("1970/01/01"),
						n = i.displayed;
					s.setFullYear(n.getFullYear()), s.setMonth(n.getMonth()), s.setDate(a.data("zDay")), i.radius = parseInt(d.find(".date_selected .date_txt").text()), i.selectRangeByCenterDate(s, i.radius), i.showval()
				}
			}), d.on("click", ".ico_minus", function(t) {
				0 !== i.radius && (i.radius--, 0 === i.radius && e(this).addClass("disabled"), 9 === i.radius && d.find(".ico_plus").removeClass("disabled"), a())
			}).on("click", ".ico_plus", function(t) {
				10 !== i.radius && (i.radius++, 1 === i.radius && d.find(".ico_minus").removeClass("disabled"), 10 === i.radius && e(this).addClass("disabled"), a())
			}).on("click", ".cus_days .tag", function(t) {
				t.stopPropagation(), i.selected || (i.selected = new Date);
				var a = e(this);
				i.rangeLen = a.data("range"), a.addClass("selected").siblings().removeClass("selected"), i.showval()
			}), d.on("click", ".month_prev", function(e) {
				var t = new Date(i.displayed.getFullYear(), i.displayed.getMonth(), 1);
				i.start && t <= i.start || s(-1)
			}).on("click", ".month_next", function(e) {
				var t = new Date(i.displayed.getFullYear(), i.displayed.getMonth() + 1, 0);
				i.end && t >= i.end || s(1)
			}), d.on("click", ".btn_confirm", function(e) {
				i.close(!0)
		...
		set: function(t, a) {
			var s = this;
			"string" == typeof t ? this[t] = a : e.isPlainObject(t) && e.each(t, function(e, t) {
				s[e] = t
			})
		},
		switchMode: function(e) {
			this.mode = e;
			var t = this.$dom.find(".cus_checkbox i"),
				a = this.$dom.find(".calendar_tag"),
				s = this.$dom.find(".cus_checkbox .date_selected"),
				n = this.$dom.find(".calendar_tit"),
				i = this.$dom.find(".calendar_box"),
				d = this.$dom.find(".cus_days");
			e.indexOf("center") !== -1 && (a.slideUp(), s.show(), n.show(), i.show(), t.hasClass("ico_checkbox") && t.removeClass("ico_checkbox").addClass("ico_checkbox_active")), e.indexOf("length") !== -1 && (a.slideDown(), s.hide(), n.hide(), i.hide(), t.hasClass("ico_checkbox_active") && t.removeClass("ico_checkbox_active").addClass("ico_checkbox")), e.indexOf("acc") === -1 ? d.hide() : d.show()
		},
		selectRange: function(t, a, s) {
			var n, i = this.selected,
				r = this.displayed,
				l = M(this.start, "start"),
				c = M(this.end, "end"),
				o = this.$dom,
				h = this.$input,
				g = H.months[this.language] || H.months._default,
				u = [];
			if (l && l.setHours(0, 0, 0, 0), c && c.setHours(23, 59, 59, 999), "string" == typeof t && t && void 0 === a && void 0 === s) {
				if (n = d.exec(t)) return "m" === n[1].toLowerCase() ? this.selectMonth(n[2]) : this.selectYear(n[2]);
				for (var f = t.split(","), m = 0; m < f.length; m++) n = F(f[m]), t = new Date(n.from), a = new Date(n.to), u.push({
					from: new Date(t.setHours(0, 0, 0, 0)),
					to: new Date(a.setHours(23, 59, 59, 999))
				})
			} else {
				if (t = t || l, a = a || c, !t && !a) return;
				if (t instanceof Date || (t = new Date(t)), a instanceof Date || (a = new Date(a)), l && t.getTime() < l.getTime() && (t = l), c && a.getTime() > c.getTime() && (a = c), t.getTime() > a.getTime()) return;
				u.push({
					from: t,
					to: a
				})
			}
			var p = e.Event("beforeselect");
			h.trigger(p, this), p.result !== !1 && (this.displayRange = u, "range_center" !== this.mode && "range_center_acc" !== this.mode || (t.getFullYear() !== r.getFullYear() && r.setFullYear(t.getFullYear()), r.setMonth(t.getMonth()), U(o, i, r, l, c, g, this.dateUpdater, this.titleUpdater, this.displayRange, this.mode)), h.trigger("afterselect", this))
		},
		selectRangeByCenterDate: function(e, t) {
			t = t || this.radius, this.selected = e || new Date;
			var a = this.selected.getDate();
			this.selectRange(new Date(this.selected).setDate(a - t), new Date(this.selected).setDate(a + t), !0)
		},
		selectRangeByLen: function(e, t) {
			t = t || this.radius, this.selected = e || new Date;
			var a = this.selected.getDate();
			this.$dom.find("input:checkbox").eq(1).is(":checked") ? this.selectRange(new Date(this.selected).setDate(a - 2), new Date(this.selected).setDate(a + 2), !0) : this.selectRange(new Date(this.selected).setDate(a), new Date(this.selected).setDate(a), !0)
		},
		selectMonth: function(e, t) {
			var a, s = new Date;
			t && s.setFullYear(t), s.setMonth(+e - 1, 1, 0), a = new Date(s), a.setMonth(e, 0), this.selectRange(s, a)
		},
		selectYear: function(e) {
			var t, a = new Date;
			a.setFullYear(e, 0, 1, 0), t = new Date(a), t.setMonth(12, 0, 0), this.selectRange(a, t)
		},
		hide: function() {
			this.$dom.hide()
		},
		close: function(t) {
			if (t) {
				if ("range_length" === this.mode || "range_length_acc" === this.mode) {
					var a = [],
						s = this.$dom.find(".calendar_tag").children(".selected");
					s.each(function() {
						a.push(e(this).data("range"))
					}), void 0 !== a[0] && this.selectRange(a.join(","))
				} else this.radius = parseInt(this.$dom.find(".date_selected .date_txt").text()), this.selectRangeByCenterDate(this.selected, this.radius);
				this.showval()
		...
		showval: function() {
			...
			if (this.range) {
				if ("range_length" === this.mode || "range_length_acc" === this.mode) {
					var a = this.$dom.find(".calendar_tag").children(".selected"),
						s = [];
					a.each(function() {
						s.push(e(this).text())
					}), t = s[0], t += s.length > 1 ? "..." : ""
				} else {
					var n = parseInt(this.$dom.find(".date_txt").text());
					t = k(this.selected, "yyyy-mm-dd"), t += n ? "前后" : ""
				}
				t += "range_length" === this.mode || "range_center" === this.mode ? " 出发" : this.valLen()
			} else t = "任何时间", "range_length_acc" === this.mode && this.valLen() && (t = this.valLen());
			this.$input.val(t), this.$input.trigger("confirm", this)
		},
		val: function(e) {
			return e = e || "yyyy-mm-dd", this.range ? k(this.range[0], e) + "~" + k(this.range[1], e) : ""
		},
		valLen: function(e, t) {
			return this.rangeLen ? " 出游" + this.rangeLen[0] + "~" + this.rangeLen[1] + "天" : ""
		},
		destroy: function() {
			this.$dom.remove(), this.$input.data("datePicker", null), this.$input.off("init beforeselect afterselect"), this.needRemoveReadonly && this.$input.removeAttr("readonly"), this.$input = null
		}
	};
	var H = e.fn.datePicker = function(t) {
			return this.each(function() {
				var a = e(this),
					n = a.data("datePicker");
				n || a.data("datePicker", new s(a, t))
			})
		},
	...
	H.months = {
		...
		_default: I,
		cn: ["日", "一", "二", "三", "四", "五", "六"]
	}, H.defaults = R, e.DatePicker = s, s.getFestivalInfo = function(e) {
		var t, a = e.getDate(),
			s = e.getMonth() + 1;
		if (t = "" + (s < 10 ? "0" : "") + s + (a < 10 ? "0" : "") + a, t in b) return {
			date: e,
			type: "solar",
			key: t,
			value: b[t]
		...
		var n = w(e),
			i = 0 | n.day,
			d = n.month;
		return t = "" + (d < 10 ? "0" : "") + d + (i < 10 ? "0" : "") + i, t in C && {
			date: e,
			type: "lunar",
			key: t,
			value: C[t]
